...
public class MeetingSections {
    ...
    public MeetingSections(Integer id, String courseId, String courseCode, String sectionCode, String instructors,
            String times, Integer size, Integer enrolment, String notes) {
        this.id = id;
